...
export const fortLee: Town = {
  id: 'nj-bergen-fort-lee',
  name: 'Fort Lee',
  state: 'NJ',
  county: 'Bergen',

  zones: [
    // Zone 1 (RecycleCoach zone: zone-z13855)
    {
      id: 'fortLee-zone-1',
      name: 'Zone 1',
    ...
    // Zone 2 (RecycleCoach zone: zone-z13856)
    {
      id: 'fortLee-zone-2',
      name: 'Zone 2',
    ...
    // Zone 3 (RecycleCoach zone: zone-z13857)
    {
      id: 'fortLee-zone-3',
      name: 'Zone 3',
    ...
    // Zone 4 (RecycleCoach zone: zone-z13858)
    {
      id: 'fortLee-zone-4',
      name: 'Zone 4',
    ...
    // Zone 5 (RecycleCoach zone: zone-z13860)
    {
      id: 'fortLee-zone-5',
      name: 'Zone 5',
      description: 'Garbage collected TODO: verify',
  ...
  // recyclingCenter: {
  //   name: 'Fort Lee Recycling Center',
  //   address: 'TODO',
